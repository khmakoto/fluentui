...
const FADE_OUT = memoizeFunction(() =>
  keyframes({
    from: { opacity: 1 },
...
const SLIDE_RIGHT_IN10 = memoizeFunction(() => _createSlideInX(-10));
const SLIDE_RIGHT_IN20 = memoizeFunction(() => _createSlideInX(-20));
const SLIDE_RIGHT_IN40 = memoizeFunction(() => _createSlideInX(-40));
const SLIDE_RIGHT_IN400 = memoizeFunction(() => _createSlideInX(-400));
const SLIDE_LEFT_IN10 = memoizeFunction(() => _createSlideInX(10));
const SLIDE_LEFT_IN20 = memoizeFunction(() => _createSlideInX(20));
const SLIDE_LEFT_IN40 = memoizeFunction(() => _createSlideInX(40));
const SLIDE_LEFT_IN400 = memoizeFunction(() => _createSlideInX(400));
const SLIDE_UP_IN10 = memoizeFunction(() => _createSlideInY(10));
const SLIDE_UP_IN20 = memoizeFunction(() => _createSlideInY(20));
const SLIDE_DOWN_IN10 = memoizeFunction(() => _createSlideInY(-10));
const SLIDE_DOWN_IN20 = memoizeFunction(() => _createSlideInY(-20));

const SLIDE_RIGHT_OUT10 = memoizeFunction(() => _createSlideOutX(10));
const SLIDE_RIGHT_OUT20 = memoizeFunction(() => _createSlideOutX(20));
const SLIDE_RIGHT_OUT40 = memoizeFunction(() => _createSlideOutX(40));
const SLIDE_RIGHT_OUT400 = memoizeFunction(() => _createSlideOutX(400));
const SLIDE_LEFT_OUT10 = memoizeFunction(() => _createSlideOutX(-10));
const SLIDE_LEFT_OUT20 = memoizeFunction(() => _createSlideOutX(-20));
const SLIDE_LEFT_OUT40 = memoizeFunction(() => _createSlideOutX(-40));
const SLIDE_LEFT_OUT400 = memoizeFunction(() => _createSlideOutX(-400));
const SLIDE_UP_OUT10 = memoizeFunction(() => _createSlideOutY(-10));
const SLIDE_UP_OUT20 = memoizeFunction(() => _createSlideOutY(-20));
const SLIDE_DOWN_OUT10 = memoizeFunction(() => _createSlideOutY(10));
const SLIDE_DOWN_OUT20 = memoizeFunction(() => _createSlideOutY(20));

const SCALE_UP100 = memoizeFunction(() =>
  keyframes({
...
const SCALE_DOWN98 = memoizeFunction(() =>
  keyframes({
...
const SCALE_DOWN100 = memoizeFunction(() =>
  keyframes({
...
const SCALE_UP103 = memoizeFunction(() =>
  keyframes({
    from: { transform: 'scale3d(1,1,1)' },
...
const ROTATE90 = memoizeFunction(() =>
  keyframes({
...
const ROTATE_N90 = memoizeFunction(() =>
  keyframes({
    from: { transform: 'rotateZ(0deg)' },
    to: { transform: 'rotateZ(-90deg)' },
  }),
